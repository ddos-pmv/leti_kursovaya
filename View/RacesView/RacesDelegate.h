...
#ifndef RACESDELEGATE_H
#define RACESDELEGATE_H
#include <QStyledItemDelegate>
#include <QPainter>

#include "../MainThemeVars.h"

class RacesDelegate : public QStyledItemDelegate {
public:
    explicit RacesDelegate(QObject* parent = nullptr) : QStyledItemDelegate(parent) {}
